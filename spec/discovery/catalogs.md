...
| `tasks` | **Demo application** | No | Task-as-obligation-list coordination (see [notes/2026-05-06-task-obligation-model.md](../../notes/2026-05-06-task-obligation-model.md)). Seeds `the_taskboard` as a `$task_registry`; depends on `note`. |
