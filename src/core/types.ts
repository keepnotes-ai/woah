...
export type MetricEvent =
  ...
  | { kind: "rest_v2_in_process_fallback"; reason: "no_commit_scope" | "incomplete_transcript"; scope: ObjRef; target: ObjRef; verb: string; route: "direct" | "sequenced"; persistence: "durable" | "live" }
